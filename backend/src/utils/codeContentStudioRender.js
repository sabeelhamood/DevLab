      ...
      <section style="display:grid;gap:16px;">
        ...
        <div data-role="codemirror-container" style="border-radius:14px;overflow:hidden;border:1px solid rgba(148,163,184,0.5);background:#ffffff;">
          <iframe
            ...
            srcdoc="${serializeJsonForScript(buildCodeMirrorTemplateForQuestion(question))}"
                ...
                onConfirm: async ({ overlay, status }) => {
                  try {
                    ...
                    const solutionCard =
                      ...
                      '<pre style="margin:0;border-radius:12px;background:#020617;color:#e5e7eb;font-family:system-ui,-apple-system,BlinkMacSystemFont,\"Segoe UI\",sans-serif;font-size:0.8rem;line-height:1.6;white-space:pre-wrap;word-break:break-word;padding:12px 14px;">' +
