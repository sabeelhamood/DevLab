...
import { securityAuditService } from '../../services/security/auditService.js';
...
router.get('/events/severity/:severity', (req, res) => {
  try {
    ...
    const events = securityAuditService.getEventsBySeverity(severity);
...
router.get('/events/type/:type', (req, res) => {
  try {
    ...
    const events = securityAuditService.getEventsByType(type);
