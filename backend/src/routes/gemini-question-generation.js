    ...
    try {
      ...
      const questionsToSave = processedQuestions.map((q, index) => {
        ...
        const questionForStorage = {
          ...
          topic_name: topicName,
          topicName: topicName,
          difficulty: q.difficulty || null, // Difficulty is generated by Gemini
          programming_language: q.language || language,
          ...
          ajax: q.ajax || {
            ...
            hints: q.hints || [],
            humanLanguage: 'en',
            difficulty: q.difficulty || null // Difficulty is generated by Gemini/Assessment service
          }
        }
