...
- (2025-11-09) Assessment microservice requests for coding questions supply `topic_name`, `programming_language`, `number_of_questions`, and a unified `skills` array; DEVLAB must return an AJAX-friendly package without hints or solutions, preserving Judge0 configuration for Assessment’s own workflows.
